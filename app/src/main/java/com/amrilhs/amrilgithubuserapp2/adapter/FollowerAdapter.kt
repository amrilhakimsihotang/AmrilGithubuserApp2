...
import com.amrilhs.amrilgithubuserapp2.model.UsersFollower
        ...
        fun bind(usersFollower: UsersFollower) {
            with(itemView) {
                Glide.with(itemView.context)
                    ...
                    .into(followeravatar)
                followerfullName.text=usersFollower.name
                followerusername.text= itemView.context.getString(R.string.det_username, usersFollower.username)
                followerrepository.text=itemView.context.getString(R.string.repository,usersFollower.repository)
                followerfollowers.text=itemView.context.getString(R.string.followers,usersFollower.followers)
                followerfollowing.text=itemView.context.getString(R.string.followings,usersFollower.following)
