...
import com.amrilhs.amrilgithubuserapp2.adapter.FollowerAdapter
...
class FollowerFragment : Fragment() {
    ...
    private lateinit var userfollowerviewmodel: UserFollowerViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        userfollowerviewmodel = ViewModelProvider(
        ...
        userfollowerviewmodel.getDataGit(requireActivity().applicationContext,usersFollower!!.username.toString())
        showprogressBarFollower(true)

        userfollowerviewmodel.getAllFollower().observe(activity!!, Observer { listFollower ->
